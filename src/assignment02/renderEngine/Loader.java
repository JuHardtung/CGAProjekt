...
public class Loader {
	...
	public RawModel loadToVAO(FloatBuffer vertices, IntBuffer indices, int vertexCount) {
		// TODO: setup VAO //
	...
	public Entity loadPyramid(Vector3f position, Vector3f orientation, Vector3f scale) {
